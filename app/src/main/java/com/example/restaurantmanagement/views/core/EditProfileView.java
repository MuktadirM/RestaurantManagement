 ...
 */
public class EditProfileView extends Fragment {
    ...
    public static EditProfileView newInstance(String param1, String param2) {
        EditProfileView fragment = new EditProfileView();
